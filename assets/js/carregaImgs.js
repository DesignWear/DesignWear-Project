...
function carregarImagens() {
    fetch('imagens.json')
        ...
        .then(data => {
            ...
            document.getElementById('btnAula2').src = imagens.btnAula1.url;

            document.getElementById('btnAula3').src = imagens.btnAula1.url;

            document.getElementById('btnAula4').src = imagens.btnAula1.url;
        })
