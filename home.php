...
$data = $_GET['search'];
$sql =
"SELECT * FROM professor WHERE idprofessor LIKE '%$data%' or nome LIKE '%$data%' or email LIKE '%$data%' or login LIKE '%$data%' ORDER BY idprofessor DESC";
}
else
{
...
--><html>
	...
	<body>
		...
		<header id="header">
			...
			<div>
				<header>
					<img src="./assets/images/banner superior.png"
					...
					<img
						...
						width: 90%; 
						height: 10%"
						src="./assets/images/banner Minha Turma.png" />
					<img
						style="position: absolute;
						left: 035px; 
						top: 250px;
						width: 90%; 
						height: 8%"
						src="./assets/images/banner status aula- Apresentação da peça Aula 1 - Saia.png" 
						onClick="umClique()"/>
				</header>
			</div>
		</section>
			...
			<li>
				<a href="./home.php">
					<img style="position: absolute;
							...
							width: 10%; 
							height: 5%"
						src="./assets/images/botão HOME.png" />
				</a>
				<form action="./notas.php" method="POST">
					...
					<img style="position: absolute;
							...
							width: 10%; 
							height: 5%"
						src="./assets/images/botão NOTAS.png" />
					<input
						style="
							position: absolute;
    						left: 114px;
